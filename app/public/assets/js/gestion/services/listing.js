...
$(document).ready(function () {
     ...
     * Initialisation
     */
    var url_donnees = '/ajax/gestion/services/recherche/';
    ...
    var tableau_ajout_service = function(service) {
        $donnees.append(
            $('<tr class="item"></tr>').append(
                '<td><a href="/gestion/service/' + service.id + '/modification">' + service.label + '</a></td>',
                '<td><a href="mailto:' + service.balf + '">' + service.balf + '</a></td>',
            )
        );
    };
